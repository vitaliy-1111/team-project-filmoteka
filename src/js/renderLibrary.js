      ...
      if (poster_path === null) {
        URL = 'https://ik.imagekit.io/tc8jxffbcvf/default-movie-portrait_EmJUj9Tda5wa.jpg?tr=fo-auto,di-%27;';
           ...
           return `<li class="list card-item">
            ...
            <button class="image-btn button-queue" id="${id}" data-type="queue">add to Queue</button>
      ...
      if (poster_path === null) {
        URL = 'https://ik.imagekit.io/tc8jxffbcvf/default-movie-portrait_EmJUj9Tda5wa.jpg?tr=fo-auto,di-%27;';
           ...
           return `<li class="list card-item">
            ...
            <div class="gallery-buttons">
              <button class="image-btn button-watched" id="${id}" data-type="watched">add to Watched</button>
